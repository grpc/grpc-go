...
[Example code unary RPC](https://github.com/grpc/grpc-go/tree/master/examples/helloworld/mock_proto)
...
From the directory ``` examples/helloworld/ ``` run ``` mockgen google.golang.org/grpc/examples/helloworld/proto GreeterClient > mock_proto/hw_mock.go ```
...
import hwmock "google.golang.org/grpc/examples/helloworld/mock_proto"
```
