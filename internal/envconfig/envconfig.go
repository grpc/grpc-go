...
var (
	...
	// XDSRecoverPanic indicates whether the xDS resolver should recover from
	// panics while parsing xDS resources.
	//
	...
	XDSRecoverPanic = boolFromEnv("GRPC_EXPERIMENTAL_XDS_PANIC_RECOVERY", true)
)
