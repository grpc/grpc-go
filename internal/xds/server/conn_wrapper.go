...
func (c *connWrapper) XDSHandshakeInfo() (*xdsinternal.HandshakeInfo, error) {
	if c.filterChain.securityCfg == nil {
		...
		return xdsinternal.NewHandshakeInfo(nil, nil, nil, false, "", false), nil
	}
	...
	return xdsinternal.NewHandshakeInfo(c.rootProvider, c.identityProvider, nil, secCfg.RequireClientCert, "", false), nil
}
