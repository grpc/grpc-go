			...
			wantUpdate: ClusterUpdate{
				...
				SecurityCfg: &SecurityConfig{
					...
					SubjectAltNameMatchers: []matcher.StringMatcher{
						matcher.NewStringMatcher(newStringP(sanExact), nil, nil, nil, nil, true),
						matcher.NewStringMatcher(nil, newStringP(sanPrefix), nil, nil, nil, false),
						matcher.NewStringMatcher(nil, nil, newStringP(sanSuffix), nil, nil, false),
						matcher.NewStringMatcher(nil, nil, nil, nil, sanRE, false),
						matcher.NewStringMatcher(nil, nil, nil, newStringP(sanContains), nil, false),
					},
				},
				TelemetryLabels: xdsinternal.UnknownCSMLabels,
			},
