...
// EndpointHostname returns the hostname from the Attributes of the given
// Endpoint. If this attribute is not set, it returns the empty string.
func EndpointHostname(endpoint resolver.Endpoint) string {
