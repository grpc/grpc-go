...
// combinedAddressesIfReadyLocked creates a list of combined addresses by
...
func (r *delegatingResolver) combinedAddressesIfReadyLocked() ([]resolver.Address, []resolver.Endpoint, bool) {
	...
	return addresses, endpoints, true
}
