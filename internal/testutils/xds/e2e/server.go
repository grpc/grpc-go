...
type ManagementServerOptions struct {
	...
	// ServerFeaturesIgnoreResourceDeletion if set to true will indicate that the
	// server features list in the bootstrap config contains `ignore_resource_deletion`.
