...
func (bb *baseBuilder) Build(cc ClientConn, opt BuildOptions) Balancer {
	bal := &baseBalancer{
		cc:            cc,
	...
	bal.picker = NewErrPicker(ErrNoSubConnAvailable)
	return bal
}
...
func (b *baseBalancer) UpdateClientConnState(s ClientConnState) error {
...
func (b *baseBalancer) regeneratePicker() {
	...
	readySCs := make(map[SubConn]SubConnInfo)
...
func (b *baseBalancer) UpdateSubConnState(sc SubConn, state SubConnState) {
	...
	b.cc.UpdateState(State{ConnectivityState: b.state, Picker: b.picker})
}
