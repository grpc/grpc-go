...
func file_grpc_core_stats_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_grpc_core_stats_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Bucket); i {
			case 0:
				return &v.state
			case 1:
		...
		file_grpc_core_stats_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_grpc_core_stats_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Metric); i {
			case 0:
				return &v.state
			case 1:
		...
		file_grpc_core_stats_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Stats); i {
			case 0:
				return &v.state
			case 1:
