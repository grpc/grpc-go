...
func file_interop_stress_grpc_testing_metrics_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_interop_stress_grpc_testing_metrics_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_interop_stress_grpc_testing_metrics_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_interop_stress_grpc_testing_metrics_proto_msgTypes[2].Exporter = func(v any, i int) any {
