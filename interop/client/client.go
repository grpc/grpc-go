...
var (
	...
	soakRequestSize                        = flag.Int("soak_request_size", 271828, "The request size in a soak RPC")
	soakResponseSize                       = flag.Int("soak_response_size", 314159, "The response size in a soak RPC")
