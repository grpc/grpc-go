...
[`UnaryClientInterceptor`](https://godoc.org/github.com/arshanvit/grpc-go#UnaryClientInterceptor)
...
`DialOption`
[`WithUnaryInterceptor`](https://godoc.org/github.com/arshanvit/grpc-go#WithUnaryInterceptor).

#### Stream Interceptor

[`StreamClientInterceptor`](https://godoc.org/github.com/arshanvit/grpc-go#StreamClientInterceptor)
...
`DialOption`
[`WithStreamInterceptor`](https://godoc.org/github.com/arshanvit/grpc-go#WithStreamInterceptor).
...
[`UnaryServerInterceptor`](https://godoc.org/github.com/arshanvit/grpc-go#UnaryServerInterceptor)
...
`ServerOption`
[`UnaryInterceptor`](https://godoc.org/github.com/arshanvit/grpc-go#UnaryInterceptor).

#### Stream Interceptor

[`StreamServerInterceptor`](https://godoc.org/github.com/arshanvit/grpc-go#StreamServerInterceptor)
...
`ServerOption`
[`StreamInterceptor`](https://godoc.org/github.com/arshanvit/grpc-go#StreamInterceptor).
