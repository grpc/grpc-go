...
func file_examples_features_proto_echo_echo_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_examples_features_proto_echo_echo_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_examples_features_proto_echo_echo_proto_msgTypes[1].Exporter = func(v any, i int) any {
