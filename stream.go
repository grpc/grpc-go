...
func (cs *clientStream) SendMsg(m interface{}) (err error) {
	...
	defer func() {
		...
		if err != nil && err != io.EOF {
			// Call finish only for errors generated by this SendMsg call.
			// (Transport errors are converted to an io.EOF error below.)
			cs.finish(err)
		}
	}()
...
func (cs *clientStream) RecvMsg(m interface{}) (err error) {
	defer func() {
		if err != nil {
			...
			//
			// For non-server-streaming RPCs, we return nil instead of EOF on success
