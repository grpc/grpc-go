...
func (cs *clientStream) SendMsg(m interface{}) (err error) {
	...
	overallTimer := stat.NewTimer("/send")
...
func (cs *clientStream) RecvMsg(m interface{}) error {
	stat := cs.attempt.s.Stat()
	overallTimer := stat.NewTimer("/clientStream/RecvMsg")
...
func (cs *clientStream) finish(err error) {
	...
	overallTimer := stat.NewTimer("/finish")
	cs.mu.Lock()
	if cs.finished {
		cs.mu.Unlock()
		overallTimer.Egress()
...
func (a *csAttempt) recvMsg(m interface{}, payInfo *payloadInfo) (err error) {
	...
	err = recv(a.p, cs.codec, a.s, a.dc, m, *cs.callInfo.maxReceiveMessageSize, payInfo, a.decomp, stat)
	timer.Egress()
	if err != nil {
		if err == io.EOF {
	...
	timer = stat.NewTimer("/trailer")
	err = recv(a.p, cs.codec, a.s, a.dc, m, *cs.callInfo.maxReceiveMessageSize, nil, a.decomp, stat)
	timer.Egress()
	if err == nil {
...
func (ss *serverStream) SendMsg(m interface{}) (err error) {
	stat := ss.s.Stat()
	overallTimer := stat.NewTimer("/serverStream/SendMsg")
...
func (ss *serverStream) RecvMsg(m interface{}) (err error) {
	stat := ss.s.Stat()
	overallTimer := stat.NewTimer("/serverStream/RecvMsg")
