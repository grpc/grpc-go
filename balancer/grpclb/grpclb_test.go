...
func (c *serverNameCheckCreds) OverrideServerName(_ string) error {
	return nil
}
...
func (s *testServer) FullDuplexCall(_ testgrpc.TestService_FullDuplexCallServer) error {
	return nil
}
...
func (s) TestGRPCLBStatsQuashEmpty(t *testing.T) {
	...
	defer close(ch)
	if err := runAndCheckStats(t, false, ch, func(_ *grpc.ClientConn) {
