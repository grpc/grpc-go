...
import fmt "fmt"
import math "math"
import v2 "google.golang.org/grpc/balancer/xds/internal/proto/envoy/api/v2"
...
func (*AdsDummy) Descriptor() ([]byte, []int) {
	return fileDescriptor_ads_e1e7637a1ab6a622, []int{0}
}
...
func init() {
	proto.RegisterFile("envoy/service/discovery/v2/ads.proto", fileDescriptor_ads_e1e7637a1ab6a622)
}

var fileDescriptor_ads_e1e7637a1ab6a622 = []byte{
