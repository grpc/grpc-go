...
func (*TcpProtocolOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_protocol_e5eb20b64f29aa63, []int{0}
}
...
func (*HttpProtocolOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_protocol_e5eb20b64f29aa63, []int{1}
}
...
func (*Http1ProtocolOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_protocol_e5eb20b64f29aa63, []int{2}
}
...
func (*Http2ProtocolOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_protocol_e5eb20b64f29aa63, []int{3}
}
...
func (*GrpcProtocolOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_protocol_e5eb20b64f29aa63, []int{4}
}
...
func init() {
	proto.RegisterFile("envoy/api/v2/core/protocol.proto", fileDescriptor_protocol_e5eb20b64f29aa63)
}

var fileDescriptor_protocol_e5eb20b64f29aa63 = []byte{
