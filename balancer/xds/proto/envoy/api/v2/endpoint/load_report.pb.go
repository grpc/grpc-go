...
func (*UpstreamLocalityStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_load_report_0ae4923b0f22347a, []int{0}
}
...
func (*UpstreamEndpointStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_load_report_0ae4923b0f22347a, []int{1}
}
...
func (*EndpointLoadMetricStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_load_report_0ae4923b0f22347a, []int{2}
}
...
func (*ClusterStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_load_report_0ae4923b0f22347a, []int{3}
}
...
func (*ClusterStats_DroppedRequests) Descriptor() ([]byte, []int) {
	return fileDescriptor_load_report_0ae4923b0f22347a, []int{3, 0}
}
...
func init() {
	proto.RegisterFile("envoy/api/v2/endpoint/load_report.proto", fileDescriptor_load_report_0ae4923b0f22347a)
}

var fileDescriptor_load_report_0ae4923b0f22347a = []byte{
