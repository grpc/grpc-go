...
type (
	...
	// TODO(arjan-bal): Remove this when implementing the dualstack design.
	// This is a hack. Once Dualstack is completed, outlier detection will stop
	// sending ejection updates through the connectivity listener.
...
// TODO(arjan-bal): This is a hack to disable outlier_detection via the
// with connectivity listener when using pick_first. Once Dualstack changes
// are complete, all SubConns will be created by pick_first and outlier
// detection will only use the health listener for ejection. This hack can
// then be removed.
