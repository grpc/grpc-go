...
func init() {
	version.RegisterClientBuilder(clientBuilder{})
}

type clientBuilder struct{}

func (clientBuilder) Build(cc *grpc.ClientConn, opts version.BuildOptions) (version.APIClient, error) {
...
func newClient(cc *grpc.ClientConn, opts version.BuildOptions) (version.APIClient, error) {
...
func (v2c *client) processWatchInfo(t *watchAction) (target []string, typeURL, version, nonce string, send bool) {
	v2c.mu.Lock()
	defer v2c.mu.Unlock()
	...
	if t.typeURL == common.V2ListenerURL {
...
func (v2c *client) recv(stream adsStream) bool {
	...
	for {
		...
		case common.V2ListenerURL, common.V3ListenerURL:
			respHandleErr = v2c.handleLDSResponse(resp)
		case common.V2RouteConfigURL, common.V3RouteConfigURL:
			respHandleErr = v2c.handleRDSResponse(resp)
		case common.V2ClusterURL, common.V3ClusterURL:
			respHandleErr = v2c.handleCDSResponse(resp)
		case common.V2EndpointsURL, common.V3EndpointsURL:
...
func (v2c *client) handleLDSResponse(resp *v2xdspb.DiscoveryResponse) error {
	update, err := common.UnmarshalListener(resp.GetResources(), v2c.logger)
	if err != nil {
		return err
	}
...
func (v2c *client) handleRDSResponse(resp *v2xdspb.DiscoveryResponse) error {
	...
	update, err := common.UnmarshalRouteConfig(resp.GetResources(), hostname, v2c.logger)
	if err != nil {
		return err
	}
...
func (v2c *client) handleCDSResponse(resp *v2xdspb.DiscoveryResponse) error {
	update, err := common.UnmarshalCluster(resp.GetResources(), v2c.logger)
	if err != nil {
		return err
	}
...
func (v2c *client) handleEDSResponse(resp *v2xdspb.DiscoveryResponse) error {
	update, err := common.UnmarshalEndpoints(resp.GetResources(), v2c.logger)
	if err != nil {
		return err
	}
