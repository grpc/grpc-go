...
func TestOverloadDropConfigEqual(t *testing.T) {
	tests := []struct {
		name string
		d1   OverloadDropConfig
		d2   OverloadDropConfig
		want bool
	}{
		{
			name: "category",
			d1:   OverloadDropConfig{Numerator: 1, Denominator: 2, Category: "test1"},
			d2:   OverloadDropConfig{Numerator: 1, Denominator: 2, Category: "test10"},
			want: false,
		},
		{
			name: "denominator",
			d1:   OverloadDropConfig{Numerator: 1, Denominator: 2, Category: "test1"},
			d2:   OverloadDropConfig{Numerator: 1, Denominator: 20, Category: "test1"},
			want: false,
		},
		{
			name: "numerator",
			d1:   OverloadDropConfig{Numerator: 1, Denominator: 2, Category: "test1"},
			d2:   OverloadDropConfig{Numerator: 2, Denominator: 2, Category: "test1"},
			want: false,
		},
		{
			name: "equal",
			d1:   OverloadDropConfig{Numerator: 1, Denominator: 2, Category: "test1"},
			d2:   OverloadDropConfig{Numerator: 1, Denominator: 2, Category: "test1"},
			want: true,
		},
	}
	for _, tt := range tests {
