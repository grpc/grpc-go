...
type testServer struct {
	...
	requestChan chan *v3discoverypb.DiscoveryRequest // channel to send received requests on to verify
}

// setupTestServer set up the gRPC server for AggregatedDiscoveryService.
