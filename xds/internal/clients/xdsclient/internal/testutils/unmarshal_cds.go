...
func unmarshalClusterResource(r *anypb.Any, serverCfg *clients.ServerConfig) (string, ClusterUpdate, error) {
...
func validateClusterAndConstructClusterUpdate(cluster *v3clusterpb.Cluster, serverCfg *clients.ServerConfig) (ClusterUpdate, error) {
