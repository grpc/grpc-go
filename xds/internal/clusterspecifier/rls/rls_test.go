...
var rlsClusterSpecifierConfigError = testutils.MarshalAny(&testing.T{}, &rlspb.RouteLookupClusterSpecifier{
...
var rlsClusterSpecifierConfigWithoutTransformations = testutils.MarshalAny(&testing.T{}, &rlspb.RouteLookupClusterSpecifier{
	RouteLookupConfig: &rlspb.RouteLookupConfig{
		GrpcKeybuilders: []*rlspb.GrpcKeyBuilder{
			{
				Names: []*rlspb.GrpcKeyBuilder_Name{
