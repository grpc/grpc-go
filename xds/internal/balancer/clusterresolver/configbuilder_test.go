...
var (
	...
	testEndpoints   [][]resource.Endpoint

	testLocalitiesP0, testLocalitiesP1 []resource.Locality
...
func init() {
	...
	testLocalitiesP0 = []resource.Locality{
		{
	...
	testLocalitiesP1 = []resource.Locality{
		{
	...
	gotConfig, _, err := buildPriorityConfigJSON([]priorityConfig{
		{
			...
			edsResp: resource.EndpointsUpdate{
				Drops: []resource.OverloadDropConfig{
					{
...
func TestGroupLocalitiesByPriority(t *testing.T) {
	tests := []struct {
		...
		wantLocalities map[string][]resource.Locality
	}{
		{
			name:           "1 locality 1 priority",
			localities:     []resource.Locality{testLocalitiesP0[0]},
		...
		},
		{
			...
			localities:     []resource.Locality{testLocalitiesP0[0], testLocalitiesP0[1]},
			wantPriorities: []string{"0"},
			wantLocalities: map[string][]resource.Locality{
		...
		},
		{
			...
			localities:     []resource.Locality{testLocalitiesP0[0], testLocalitiesP1[0]},
		...
		localities: []resource.Locality{
			{
				Endpoints: []resource.Endpoint{
					{Address: "addr-1-1", HealthStatus: resource.EndpointHealthStatusHealthy, Weight: 90},
					{Address: "addr-1-2", HealthStatus: resource.EndpointHealthStatusHealthy, Weight: 10},
				},
			...
			{
				Endpoints: []resource.Endpoint{
					{Address: "addr-2-1", HealthStatus: resource.EndpointHealthStatusHealthy, Weight: 90},
					{Address: "addr-2-2", HealthStatus: resource.EndpointHealthStatusHealthy, Weight: 10},
				},
	...
	tests := []struct {
	...
	}{
		{
			...
			localities: []resource.Locality{
				{
					Endpoints: []resource.Endpoint{
						{Address: "addr-1-1", HealthStatus: resource.EndpointHealthStatusHealthy},
						{Address: "addr-1-2", HealthStatus: resource.EndpointHealthStatusHealthy},
					},
					ID:     internal.LocalityID{Zone: "test-zone-1"},
					Weight: 20,
				},
				{
					Endpoints: []resource.Endpoint{
						{Address: "addr-2-1", HealthStatus: resource.EndpointHealthStatusHealthy},
						{Address: "addr-2-2", HealthStatus: resource.EndpointHealthStatusHealthy},
					},
					ID:     internal.LocalityID{Zone: "test-zone-2"},
					Weight: 80,
				},
