...
// xdsClient contains only the xds_client methods needed by EDS balancer. It's
// defined so we can override xdsclient.New function in tests.
...
func init() {
	balancer.Register(edsBB{})
}

type edsBB struct{}

var _ balancer.ConfigParser = edsBB{}

// Build helps implement the balancer.Builder interface.
func (edsBB) Build(cc balancer.ClientConn, opts balancer.BuildOptions) balancer.Balancer {
	b := &edsBalancer{
		cc:                cc,
	...
	b.edsImpl = newEDSBalancer(b.cc, opts, b.enqueueChildBalancerState, b.loadWrapper, b.logger)
	b.logger.Infof("Created")
	go b.run()
	return b
}

func (edsBB) Name() string {
	return edsName
}

func (edsBB) ParseConfig(c json.RawMessage) (serviceconfig.LoadBalancingConfig, error) {
	var cfg EDSConfig
