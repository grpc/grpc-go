...
func TestEDSPriority_HighPriorityReady(t *testing.T) {
	...
	clab2.addLocality(testSubZones[2], 1, 2, testEndpointAddrs[2:3])
	...
	clab3.addLocality(testSubZones[0], 1, 0, testEndpointAddrs[:1])
	clab3.addLocality(testSubZones[1], 1, 1, testEndpointAddrs[1:2])
...
func TestEDSPriority_HigherReadyCloseAllLower(t *testing.T) {
	...
	clab1.addLocality(testSubZones[0], 1, 0, testEndpointAddrs[:1])
	clab1.addLocality(testSubZones[1], 1, 1, testEndpointAddrs[1:2])
	clab1.addLocality(testSubZones[2], 1, 2, testEndpointAddrs[2:3])
	edsb.HandleEDSResponse(clab1.build())
...
func TestEDSPriority_MultipleLocalities(t *testing.T) {
	...
	clab0.addLocality(testSubZones[0], 1, 0, testEndpointAddrs[:1])
	clab0.addLocality(testSubZones[1], 1, 1, testEndpointAddrs[1:2])
	...
	clab1.addLocality(testSubZones[0], 1, 0, testEndpointAddrs[:1])
	clab1.addLocality(testSubZones[1], 1, 1, testEndpointAddrs[1:2])
	clab1.addLocality(testSubZones[2], 1, 0, testEndpointAddrs[2:3])
	clab1.addLocality(testSubZones[3], 1, 1, testEndpointAddrs[3:4])
	edsb.HandleEDSResponse(clab1.build())
...
func TestEDSPriority_RemovesAllLocalities(t *testing.T) {
	...
	clab2 := newClusterLoadAssignmentBuilder(testClusterNames[0], nil)
	clab2.addLocality(testSubZones[0], 1, 0, testEndpointAddrs[2:3])
	clab2.addLocality(testSubZones[1], 1, 1, testEndpointAddrs[3:4])
	edsb.HandleEDSResponse(clab2.build())
	...
	clab3 := newClusterLoadAssignmentBuilder(testClusterNames[0], nil)
	clab3.addLocality(testSubZones[0], 1, 0, testEndpointAddrs[2:3])
	edsb.HandleEDSResponse(clab3.build())
