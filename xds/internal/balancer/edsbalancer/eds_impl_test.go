...
func (s) TestEDS_OneLocality(t *testing.T) {
	...
	edsb.handleEDSResponse(testutils.ParseEDSRespProtoForTesting(clab1.Build()))
	...
	edsb.handleEDSResponse(testutils.ParseEDSRespProtoForTesting(clab2.Build()))
	...
	edsb.handleEDSResponse(testutils.ParseEDSRespProtoForTesting(clab3.Build()))
	...
	edsb.handleEDSResponse(testutils.ParseEDSRespProtoForTesting(clab4.Build()))
	...
	edsb.handleEDSResponse(testutils.ParseEDSRespProtoForTesting(clab5.Build()))
	...
	edsb.handleEDSResponse(testutils.ParseEDSRespProtoForTesting(clab6.Build()))
...
func (s) TestEDS_EmptyUpdate(t *testing.T) {
	...
	edsb.handleEDSResponse(common.EndpointsUpdate{})
...
func (s) TestDropPicker(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name: "one drop",
			drops: []*dropper{
				newDropper(common.OverloadDropConfig{Numerator: 1, Denominator: 2}),
			},
		},
		{
			name: "two drops",
			drops: []*dropper{
				newDropper(common.OverloadDropConfig{Numerator: 1, Denominator: 3}),
				newDropper(common.OverloadDropConfig{Numerator: 1, Denominator: 2}),
			},
		},
		{
			...
			drops: []*dropper{
				newDropper(common.OverloadDropConfig{Numerator: 1, Denominator: 3}),
				newDropper(common.OverloadDropConfig{Numerator: 1, Denominator: 4}),
				newDropper(common.OverloadDropConfig{Numerator: 1, Denominator: 2}),
			},
		},
	}
