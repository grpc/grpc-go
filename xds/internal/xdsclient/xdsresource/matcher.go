...
//
//   - A match is better if it’s matching pattern type is better. (Exact match
//     > suffix match > prefix match > universal match.)
//
//   - If two matches are of the same pattern type, the longer match is
//     better. This is to compare the length of the matching pattern,
//     e.g. “*ABCDE” > “*ABC”
