...
func (errHTTPFilter) ParseFilterConfig(_ proto.Message) (httpfilter.FilterConfig, error) {
	return nil, fmt.Errorf("error from ParseFilterConfig")
}

func (errHTTPFilter) ParseFilterConfigOverride(_ proto.Message) (httpfilter.FilterConfig, error) {
