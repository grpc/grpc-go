...
func (s) TestHandleResponseFromManagementServer(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantURL:       "type.googleapis.com/envoy.config.listener.v3.Listener",
			wantResources: []*anypb.Any{testutils.TestMarshalAny(t, resource1)},
		},
		{
			...
			wantURL:       "type.googleapis.com/envoy.config.listener.v3.Listener",
			wantResources: []*anypb.Any{testutils.TestMarshalAny(t, resource1), testutils.TestMarshalAny(t, resource2)},
		},
		{
