...
func (nopListenerWatcher) ResourceChanged(_ clientimpl.ResourceData, onDone func()) {
	onDone()
}
...
func (nopRouteConfigWatcher) ResourceChanged(_ clientimpl.ResourceData, onDone func()) {
	onDone()
}
...
func (nopEndpointsWatcher) ResourceChanged(_ clientimpl.ResourceData, onDone func()) {
	onDone()
}
...
func (w *blockingListenerWatcher) ResourceChanged(_ clientimpl.ResourceData, onDone func()) {
