...
func (bufConn) SetDeadline(_ time.Time) error      { panic("unimplemented") }
func (bufConn) SetReadDeadline(_ time.Time) error  { panic("unimplemented") }
func (bufConn) SetWriteDeadline(_ time.Time) error { panic("unimplemented") }
