...
type loopyWriter struct {
	...
	// activeStreams is a linked-list of all streams wanting( and capable) to send data
	// and each of these streams internally have a list of data items(and perhaps trailers
