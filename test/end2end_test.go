...
func errInjector(_ context.Context, _ any, _ *grpc.UnaryServerInfo, _ grpc.UnaryHandler) (any, error) {
...
func testClientRequestBodyErrorUnexpectedEOF(t *testing.T, e env) {
	te := newTest(t, e)
	ts := &funcServer{unaryCall: func(_ context.Context, _ *testpb.SimpleRequest) (*testpb.SimpleResponse, error) {
...
func (c *clientFailCreds) ClientHandshake(_ context.Context, _ string, _ net.Conn) (net.Conn, credentials.AuthInfo, error) {
...
func (c *clientFailCreds) OverrideServerName(_ string) error {
	return nil
}
...
func (bp *triggerRPCBlockPicker) Pick(_ balancer.PickInfo) (balancer.PickResult, error) {
	bp.pickDone()
