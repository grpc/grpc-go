...
func (c clientAlwaysFailCred) ClientHandshake(_ context.Context, _ string, _ net.Conn) (net.Conn, credentials.AuthInfo, error) {
...
func (cr testPerRPCCredentials) GetRequestMetadata(_ context.Context, _ ...string) (map[string]string, error) {
	var err error
	if cr.errChan != nil {
		err = <-cr.errChan
	}
...
func (c *serverDispatchCred) OverrideServerName(_ string) error {
	return nil
}
